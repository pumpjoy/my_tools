...
class Example(QMainWindow):
    def __init__(self):
        ...
        # Create the pages for first stack layout
        self.page1 = QWidget()
        self.page2 = QWidget()

        # Add labels and buttons to first 2 pages
...
############################################################
        ...
        # Create the pages for second stack layout
        self.page3 = QWidget()
        self.page4 = QWidget()

        # Add labels and buttons to second 2 pages
